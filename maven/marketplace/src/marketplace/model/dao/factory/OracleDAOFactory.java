...
public class OracleDAOFactory extends DAOFactory {
    private static final String JDBC_ENV = "java:comp/env";
    public static final String JDBC_MYORACLE = "jdbc/myoracle";
    ...
    public static synchronized Connection createConnection()
        ...
        try {
            ...
            envContext = (Context) initContext.lookup(JDBC_ENV);
