...
/**
 * Controller for Remove from Black List.
 * 
 * @author Roman_Ten
 * 
 */
public class RemoveFromBlackListController extends AbstractController {
	...
	int bidderID = helperFactory.getUserHelper().getUserID();
	UserDAO userDAO = daoFactory.getUserDAO();
	userDAO.removeFromBlackList(user.getUserID(), bidderID);
